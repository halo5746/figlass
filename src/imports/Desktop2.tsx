import svgPaths from "./svg-7igppcw5rc";
...
function Component8() {
  return (
    <div className="h-[54px] relative shrink-0 w-full" data-name="Component 8">
      ...
      <p className="absolute font-['Inter:Medium',_sans-serif] font-medium leading-[normal] left-[67.5px] not-italic text-[#a4a4a4] text-[16px] text-center text-nowrap top-[18px] tracking-[-0.8px] translate-x-[-50%] uppercase whitespace-pre">YOUR NAME ?</p>
    </div>
  );
}
...
function Component9() {
  return (
    <div className="h-[54px] relative shrink-0 w-full" data-name="Component 9">
      <div className="absolute bg-white inset-0" />
      <p className="absolute font-['Inter:Medium',_sans-serif] font-medium leading-[normal] left-[67px] not-italic text-[#a4a4a4] text-[16px] text-center text-nowrap top-[18px] tracking-[-0.8px] translate-x-[-50%] uppercase whitespace-pre">YOUR EMAIL?</p>
    </div>
  );
}
...
function Component10() {
  return (
    <div className="h-[54px] relative shrink-0 w-full" data-name="Component 10">
      <div className="absolute bg-white inset-0" />
      <p className="absolute font-['Inter:Medium',_sans-serif] font-medium leading-[normal] left-[67px] not-italic text-[#a4a4a4] text-[16px] text-center text-nowrap top-[18px] tracking-[-0.8px] translate-x-[-50%] uppercase whitespace-pre">YOUR PHONE.?</p>
    </div>
  );
}
...
function BtnMore1() {
  return (
    <div className="bg-[#ffc800] h-[52px] relative rounded-[6px] shrink-0 w-full" data-name="btn-more">
...
function FootSns() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[45px]" data-name="foot-sns">
...
function FootSns1() {
  return (
    <div className="[grid-area:1_/_1] ml-[51px] mt-0 relative size-[45px]" data-name="foot-sns">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45 45">
        <g id="foot-sns">
          <circle cx="22.5" cy="22.5" fill="var(--fill-0, black)" id="Ellipse 8" r="22.5" />
...
function FootSns2() {
  return (
    <div className="[grid-area:1_/_1] ml-[102px] mt-0 relative size-[45px]" data-name="foot-sns">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45 45">
        <g id="foot-sns">
          <circle cx="22.5" cy="22.5" fill="var(--fill-0, black)" id="Ellipse 8" r="22.5" />
...
function Frame5() {
  return (
    <div className="bg-[#ffcc00] h-0 relative shrink-0 w-full">
...
function Frame11() {
  return (
    <button className="box-border content-stretch flex flex-col gap-[9px] items-center overflow-visible p-0 relative shrink-0 w-[77px]">
      <About1 />
      <Frame5 />
    </button>
  );
...
function Header() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-[310px] top-[68px] w-[1300px]" data-name="header">
