...
import svgPaths from "./imports/svg-7igppcw5rc";
...
function BtnMore({ onClick }: { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className="bg-[#ffc800] box-border content-stretch flex gap-[10px] h-[48px] items-center justify-center px-[30px] py-[14px] relative rounded-[6px] shrink-0 w-[187px] cursor-pointer hover:bg-[#e6b500] transition-colors"
      data-name="btn-more"
    >
...
function Frame16({ activeIndex }: { activeIndex: number }) {
  return (
    <div className="absolute content-stretch flex gap-[16px] inset-[91.45%_45.99%_6.58%_48.7%] items-center">
      {activeIndex === 0 ? <Component2 /> : <Component3 />}
      {activeIndex === 1 ? <Component2 /> : <Component3 />}
      {activeIndex === 2 ? <Component2 /> : <Component4 />}
    </div>
  );
}
...
function Spot() {
  ...
  return (
    <div className="h-[760px] relative shrink-0 w-full" data-name="spot">
      ...
      <Frame17 />
      <Frame16 activeIndex={activeSlide} />
    </div>
  );
}
    ...
    <div className="h-[36px] relative shrink-0 w-[40px]" data-name="Group">
      <div className="absolute inset-[-4.17%_-3.75%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 43 39">
          <g id="Group">
            <path d={svgPaths.p3988fd80} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
            <path d={svgPaths.p3184aa80} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinejoin="round" strokeWidth="3" />
            <path d={svgPaths.p127bc280} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
          </g>
        </svg>
      </div>
    </div>
...
function About() {
  return (
    <div id="about" className="box-border content-stretch flex flex-col gap-[70px] items-center px-0 py-[100px] relative shrink-0 w-[1300px]" data-name="about">
      <Frame18 />
      <Frame23 />
    </div>
  );
...
function Portfolio() {
  return (
    <div id="portfolio" className="bg-[#eeeeee] content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-full" data-name="portfolio">
      <Frame42 />
    </div>
  );
}
  ...
  return (
    <div className="h-[54px] relative shrink-0 w-full" data-name="Component 8">
      <input
        ...
        className="absolute bg-white inset-0 font-['Inter:Medium',_sans-serif] font-medium leading-[normal] not-italic text-[#a4a4a4] text-[16px] text-center tracking-[-0.8px] uppercase placeholder:text-[#a4a4a4] focus:outline-none focus:ring-2 focus:ring-[#ffcc00] px-[67px]"
      />
    </div>
  );
}
  ...
  return (
    <div className="h-[243px] relative shrink-0 w-full" data-name="Component 11">
      <textarea
        ...
        className="absolute bg-white inset-0 font-['Inter:Medium',_sans-serif] font-medium leading-[normal] not-italic text-[#a4a4a4] text-[16px] tracking-[-0.8px] uppercase placeholder:text-[#a4a4a4] focus:outline-none focus:ring-2 focus:ring-[#ffcc00] px-[67px] py-[18px] resize-none"
      />
    </div>
  );
}

function BtnMore1({ onClick }: { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className="bg-[#ffc800] h-[52px] relative rounded-[6px] shrink-0 w-full cursor-pointer hover:bg-[#e6b500] transition-colors"
      data-name="btn-more"
    >
...
function Frame31() {
  ...
  return (
    <form onSubmit={handleSubmit} className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[638px]">
      <Component8 />
      <Component9 />
      <Component10 />
      <Component11 />
...
function Contact() {
  return (
    <div id="contact" className="bg-[#575757] content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-full" data-name="contact">
      <Frame45 />
    </div>
  );
}
...
function FootSns() {
  return (
    <a
      href="#"
      className="[grid-area:1_/_1] ml-0 mt-0 relative size-[45px] hover:opacity-80 transition-opacity cursor-pointer"
      data-name="foot-sns"
      aria-label="Twitter"
    >
...
function FootSns1() {
  return (
    <a
      href="#"
      className="[grid-area:1_/_1] ml-[51px] mt-0 relative size-[45px] hover:opacity-80 transition-opacity cursor-pointer"
      data-name="foot-sns"
      aria-label="Facebook"
    >
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45 45">
...
function FootSns2() {
  return (
    <a
      href="#"
      className="[grid-area:1_/_1] ml-[102px] mt-0 relative size-[45px] hover:opacity-80 transition-opacity cursor-pointer"
      data-name="foot-sns"
...
function Frame5() {
  return (
    <div className="nav-dropdown bg-[#ffcc00] h-0 relative shrink-0 w-full transition-all duration-300 overflow-hidden">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] h-0 items-start p-[20px] relative w-full">
          <Sub11 />
        </div>
      </div>
    </div>
...
function Frame11() {
  ...
  return (
    <div className="nav-item box-border content-stretch flex flex-col gap-[9px] items-center overflow-visible p-0 relative shrink-0 w-[77px]">
      <button onClick={scrollToAbout} className="w-full bg-transparent border-none cursor-pointer">
        <About1 />
      </button>
      <Frame5 />
    </div>
...
function Frame12() {
  ...
  return (
    <div className="nav-item box-border content-stretch flex flex-col gap-[9px] items-center overflow-visible p-0 relative shrink-0 w-[77px]">
      <button onClick={scrollToPortfolio} className="w-full bg-transparent border-none cursor-pointer">
        <About2 />
      </button>
      <Frame6 />
    </div>
...
function Frame13() {
  ...
  return (
    <div className="nav-item box-border content-stretch flex flex-col gap-[9px] items-center overflow-visible p-0 relative shrink-0 w-[77px]">
      <button onClick={scrollToContact} className="w-full bg-transparent border-none cursor-pointer">
        <About3 />
      </button>
      <Frame7 />
    </div>
...
function Header() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-[310px] top-[68px] w-[1300px] z-50" data-name="header">
